-- ════════════════════════════════════════════════════════════════
-- RESTAURAR TODOS OS DADOS DA LOJA BY MARCELO MEDEIROS
-- Rode no Supabase SQL Editor — sobrescreve qualquer valor vazio
-- ════════════════════════════════════════════════════════════════
...
BEGIN
  INSERT INTO configuracoes (chave, valor, tipo, grupo, loja_id) VALUES
    ...
    -- RODAPÉ (usado em Política/Termos)
  ...
  RAISE NOTICE 'Restauração completa!';
END $$;

-- Verificação: lista TODOS os campos preenchidos da By Marcelo
SELECT chave, valor
FROM configuracoes
